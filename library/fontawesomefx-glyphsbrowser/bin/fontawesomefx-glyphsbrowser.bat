...
set CLASSPATH=%APP_HOME%\lib\fontawesomefx-glyphsbrowser.jar;%APP_HOME%\lib\fontawesomefx-fontawesome-4.6.3.jar;%APP_HOME%\lib\fontawesomefx-materialdesignfont-1.6.50.jar;%APP_HOME%\lib\fontawesomefx-materialicons-2.2.0.jar;%APP_HOME%\lib\fontawesomefx-octicons-4.3.0.jar;%APP_HOME%\lib\fontawesomefx-icons525-2.6.0.jar;%APP_HOME%\lib\fontawesomefx-weathericons-2.0-3.jar;%APP_HOME%\lib\controlsfx-8.40.11.jar;%APP_HOME%\lib\fontawesomefx-commons-8.12.jar
